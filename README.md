...
Tech Stack
LayerTechnologyBackendPython, Flask, Flask-SocketIODatabaseSQLiteRoutingOpenRouteService API (HGV truck profile)MapsLeaflet.jsLive TrackingBrowser Geolocation API + WebSocketsFrontendHTML, Bootstrap 5, CSSCompliance LogicCustom Python (MV Act 1988 limits hardcoded)
...
cp .env.example .env
# Edit .env and add your ORS_API_KEY and SECRET_KEY
